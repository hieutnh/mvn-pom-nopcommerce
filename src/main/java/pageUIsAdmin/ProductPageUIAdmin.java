...
public class ProductPageUIAdmin {
	...
	public static final String ERROR_MESSAGE_NO_DATA_FOUND = "//td[@class='dataTables_empty']";
	public static final String PRODUCT_INFO_TEXT = "//span[contains(text(),'Product info')]";
