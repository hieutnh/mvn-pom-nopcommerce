...
public class TestListeners extends AbstractTest implements ITestListener{
	private static ExtentReports extent = ExtentManager4.createInstance();
	...
	public void onTestFailure(ITestResult result) {
		...
		extentTest.get().fail("<detail><sumary><b><font color=red>Exception Occured, click to see details:" + "</font></b></summary>" + exceptionMessage.replace(",", "<br>") + "</details> \n");
...
//		WebDriver driver = ((TestClassUsingListeners)result.getInstance()).driver;
		...
		try {
			...
			extentTest.get().fail("Test Failed, cannot addtach screenshot");
		}
