...
//	}
	...
	public void TC_03_Random_Popup() {
		sleepInSecond(2);
		driver.findElement(By.xpath("//div[@class='nav-item right-line']//a[contains(text(),'Kích hoạt COD')]")).click();
		sleepInSecond(2);
		driver.findElement(By.xpath("//div[@id='activeCOD']")).click();
		sleepInSecond(2);
		driver.findElement(By.xpath("//div[@class='nav-item']//a[contains(text(),'Đăng ký')]")).click();
		sleepInSecond(5);
	}
